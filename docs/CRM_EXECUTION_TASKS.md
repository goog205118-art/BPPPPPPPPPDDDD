...
| 当前任务 | `CRM-70-02` |
| 当前状态 | `active` |
| 当前目标 | 建立退信、投递失败、退订、黑名单与触达频率控制；定时 IMAP 同步继续暂缓。 |
...
| `CRM-70-02` | P2 | `active` | 增加退信、投递失败、退订、黑名单与触达频率控制。 | `CRM-70-01`, `CRM-40-03` | SMTP 接收成功不再被误解为送达；不向退订/黑名单联系人发信。 |
