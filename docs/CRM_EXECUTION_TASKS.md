...
| 当前任务 | `CRM-40-04` |
| 当前状态 | `planned` |
| 当前目标 | AI 只能建议合作阶段；操作者必须带理由手动应用阶段，报价、条款、寄样、签收、发布与结案均需显式确认和可审计记录。 |
